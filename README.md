...
- Open terminal in the project folder and run <code>npm run dev</code> command to run in dev mode.
...
Feel free to check the [issues page](https://github.com/Sparktan24/Bookstore/issues).
